...
All notable changes to Maildeno are documented here. Maildeno follows https://semver.org[Semantic Versioning]. The JavaScript/TypeScript, Python, and PHP SDKs are versioned independently — the JS SDK is currently at **v2.1.3**, the Python SDK at **v2.0.3**, and the PHP SDK at **v2.0.0**.
