...
[.table-scroll, cols="1,1,3,3", options=header]
|===
...
NOTE: The PHP SDK maps other non-2xx statuses to a dedicated `UNKNOWN` code instead of `RENDER_ERROR`. See xref:php-error-handling.adoc[PHP — Error Handling] before porting error-handling logic between SDKs.
