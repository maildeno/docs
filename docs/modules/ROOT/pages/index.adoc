...
.Maildeno Platform Architecture
image::platform-architecture.png[Maildeno platform architecture diagram,role=center,width=100%]

NOTE: Images above are placeholders. Replace them with your actual screenshots once available.
...
* File a bug or feature request on https://github.com/YOUR_ORG/maildeno[GitHub].
