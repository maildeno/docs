...
All notable changes to Maildeno are documented here. Maildeno follows https://semver.org[Semantic Versioning]. The JavaScript/TypeScript, Python, and PHP SDKs are versioned independently — the JS SDK is currently at **v2.1.4**, the Python SDK at **v2.0.4**, and the PHP SDK at **v2.0.1**.
